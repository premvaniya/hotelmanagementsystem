       ...
       if(ae.getSource()==check){
           ...
           try{
               ...
               while(rs.next()){
                ...
                while(rs2.next()){
                 tfavailable.setText(rs2.getString("availabilility"));
           ...
           String status = tfstatus.getText();
               try{
               Conn c = new Conn();
               c.s.executeUpdate("Update rooms set availabilility=' "+available+"',cleaning_status='"+status+"' where roomnumber='" + room + "'");
